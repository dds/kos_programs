...
```ini
SEQUENCE = PRELAUNCH,LAUNCH,FAIR,ANTS,PARK,DEPARTURE_SHAPE,XING,BPLANE,COAST_1HALF,REFINE_BPLANE,COAST_2HALF,CAPTURE,SHAPE,DONE
...
```ini
SEQUENCE = PRELAUNCH,LAUNCH,FAIR,ANTS,PARK,XING,BPLANE,COAST_1HALF,REFINE_BPLANE,COAST_2HALF,CAPTURE,SHAPE,RELAY_CONSTELLATION,DONE

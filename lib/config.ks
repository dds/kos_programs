...
GLOBAL FUNCTION missionNumericConfigKeys {
    RETURN LIST(
        ...
        "PRELAUNCH_PLANE_LEAD", "LAUNCH_RDV_ASCENT_TIME",
        "LAUNCH_PLANE_LEAD",
        "LAUNCH_RDV_LEAD", "LAUNCH_RDV_MAX_WINDOWS", "MATCH_FINAL_DIST",
        "FAIRING_ALT", "EXTEND_ALT",
        "RELAY_ALT", "RELAY_COUNT", "CAPTURE_PE", "CAPTURE_INC", "CAPTURE_LAN",
        "CAPTURE_AOP", "TRANSFER_AOP_ERR_TOL", "TRANSFER_INC_ERR_TOL",
        "TRANSFER_AOP_SCAN_TOL", "TRANSFER_SCAN_SAMPLES_PER_ORBIT",
        "TRANSFER_SCAN_LOOKAHEAD_HOURS", "TRANSFER_SCAN_STEP_MINUTES",
        "TRANSFER_PREVIEW_SHORTLIST",
        "TRANSFER_DEFERRED_PE_ERR_TOL", "TRANSFER_DEFERRED_INC_ERR_TOL",
        "ALLOW_GRAVITY_ASSIST",
        ...
        "DESCENT_RELEASE_ALT", "DESCENT_HEAT_SHIELD_DROP_ALT",
        "DESCENT_BAY_REOPEN_ALT",
        "DESCENT_DROGUE_CUT_ALT",
        ...
        "SOI_BUFFER_TIME",
        "MIDCOURSE_REFINE_FRACTION", "MIDCOURSE_REFINE_MIN_LEAD",
        "MIDCOURSE_REFINE_MARGIN",
...
GLOBAL FUNCTION missionStringConfigKeys {
    RETURN LIST(
        "SEQUENCE", "MISSION_TYPE", "CAPTURE_DIR", "RENDEZVOUS_TARGET", "ASTEROID_TARGET",
        "LAUNCH_PLANE_MODE", "LAUNCH_PLANE_TARGET",
        "INCL_MATCH_TARGET", "SCANSAT_DECOUPLER_TAG", "SCANSAT_CLEARANCE_DIR",
        "SCANSAT_REQUIRED_TYPES",
        "PAYLOAD_1_LABEL", "PAYLOAD_1_DECOUPLER_TAG",
        "PAYLOAD_1_ANTENNA_TAG", "PAYLOAD_1_SOLAR_TAG",
        "PAYLOAD_2_ANTENNA_TAG", "PAYLOAD_2_SOLAR_TAG",
        "SECONDARY_SEQUENCE", "SECONDARY_RELEASE_TAG",
        "SECONDARY_RELEASE_ANTENNA_TAG", "SECONDARY_RELEASE_SOLAR_TAG",
        ...
        "DRONE_STYLE", "SSTO_RUNWAY", "EVA_BIOMES", "LANDING_TARGET_BIOMES"
    ).
}

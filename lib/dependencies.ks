...
GLOBAL FUNCTION dependencyLibs {
    RETURN LEXICON(
        ...
        "landing_site", LIST(),
        "abort", LIST(),
        "launch", LIST("flightplan", "orbit", "countdown", "utils"),
        "hop", LIST("utils"),
...
GLOBAL FUNCTION dependencyBands {
    RETURN LEXICON(
        ...
        "PRELAUNCH", LIST("PRELAUNCH"),
        "LAUNCH", LIST("LAUNCH", "HOP", "FAIR", "ANTS", "PARK"),
        "ABORT", LIST("ABORT"),
        "ESCAPE", LIST("ESCAPE"),
        ...
        "COAST", LIST("COAST"),
        "XFER_ARRIVE", LIST("BPLANE", "COAST_1HALF", "REFINE_BPLANE", "COAST_2HALF", "CAPTURE", "FLYBY"),

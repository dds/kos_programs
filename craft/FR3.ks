...
LOCAL FUNCTION _numericMissionKeys {
    RETURN LIST(
        ...
        "LANDING_ASSIST_SURFACE_BRAKE_TILT",
        "LANDING_ASSIST_SURFACE_HBRAKE_MARGIN",
        "LANDING_ASSIST_SURFACE_HBRAKE_FACTOR",
        "LANDING_ASSIST_SURFACE_BRAKE_RELEASE_HSPEED",
        "LANDING_ASSIST_SURFACE_BRAKE_AOA",
        "LANDING_ASSIST_SURFACE_PANIC_ALT",
        "LANDING_ASSIST_SURFACE_PANIC_SPEED",
        "LANDING_ASSIST_SURFACE_DROP_ALT",
        "LANDING_ASSIST_SURFACE_DROP_MAX_VSPEED",
        "LANDING_ASSIST_SURFACE_FINAL_ALT",
        "LANDING_ASSIST_SURFACE_FINAL_MAX_SPEED",
        "LANDING_ASSIST_SURFACE_FINAL_SPEED",
        "LANDING_ASSIST_SURFACE_FINAL_HSPEED",
        "LANDING_ASSIST_SURFACE_RELEASE_ALT",
        "LANDING_ASSIST_SURFACE_RELEASE_HSPEED",
        "LANDING_ASSIST_SURFACE_RELEASE_VSPEED",
        "LANDING_ASSIST_SURFACE_RELEASE_SETTLE",
        "LANDING_ASSIST_SURFACE_POWERED_ROVER",
        "LANDING_ASSIST_SURFACE_RELEASE_AFTER_TOUCHDOWN",

...
LOCAL FUNCTION _applyMissionProfile {
    ...
    IF DEFINED LANDING_CFG {
        ...
        IF CFG:HASKEY("LANDING_ASSIST_RELEASE_ON_SURFACE") {
            SET LANDING_CFG["ASSIST_RELEASE_ON_SURFACE"] TO CFG["LANDING_ASSIST_RELEASE_ON_SURFACE"].
        }
        IF CFG:HASKEY("LANDING_ASSIST_SURFACE_FINAL_SPEED") {
            SET LANDING_CFG["ASSIST_SURFACE_FINAL_SPEED"] TO CFG["LANDING_ASSIST_SURFACE_FINAL_SPEED"].
        }
        IF CFG:HASKEY("LANDING_ASSIST_SURFACE_SETTLE_TIME") {
            SET LANDING_CFG["ASSIST_SURFACE_SETTLE_TIME"] TO CFG["LANDING_ASSIST_SURFACE_SETTLE_TIME"].
        }
        IF CFG:HASKEY("LANDING_ASSIST_SURFACE_TIPOVER") {
            SET LANDING_CFG["ASSIST_SURFACE_TIPOVER"] TO CFG["LANDING_ASSIST_SURFACE_TIPOVER"].
        }
        IF CFG:HASKEY("LANDING_ASSIST_SURFACE_TIP_TIME") {
            SET LANDING_CFG["ASSIST_SURFACE_TIP_TIME"] TO CFG["LANDING_ASSIST_SURFACE_TIP_TIME"].
        }
    }

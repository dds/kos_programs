...
IF stateGet("secondary_active", "false") = "true" {
    ...
    IF CFG:HASKEY("SECONDARY_RELAY_ALT") { cfgSet("RELAY_ALT", CFG["SECONDARY_RELAY_ALT"]). }
    IF CFG:HASKEY("SECONDARY_TARGET_INCLINATION") {
        cfgSet("TARGET_INCLINATION", CFG["SECONDARY_TARGET_INCLINATION"]).
    }
}

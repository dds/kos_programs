...
_cfg("LANDING_ASSIST_SURFACE_RELEASE_ALT", "5").
_cfg("LANDING_ASSIST_SURFACE_RELEASE_HSPEED", "2").
_cfg("LANDING_ASSIST_SURFACE_RELEASE_VSPEED", "1.5").
_cfg("LANDING_ASSIST_SURFACE_RELEASE_SETTLE", "0.5").
_cfg("LANDING_ASSIST_SURFACE_SETTLE_TIME", "2").
_cfg("LANDING_ASSIST_SURFACE_TIPOVER", "0").
